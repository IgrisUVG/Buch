...
if (!empty($_POST["referal"])) {
    ...
    $db_referal = $mysqli->query("SELECT * FROM autors WHERE autor LIKE '%$referal%' OR title LIKE '%$referal%' OR description LIKE '%$referal%' OR cover LIKE '%$referal%'")
...
if (!empty($_POST["schrank_num"]) || !empty($_POST["regal_num"])) {
