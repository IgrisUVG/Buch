...
if (!empty($_POST["referal"])) {
    ...
    $db_referal = $mysqli->query("SELECT * FROM autors WHERE autor LIKE '%$referal%' OR title LIKE '%$referal%' OR description LIKE '%$referal%' OR inhalt LIKE '%$referal%' OR druck LIKE '%$referal%' OR notes LIKE '%$referal%'")
